...
class CancellableIsolate {
  /// A cancellable implementation of Dart's `Isolate.run` function.
  ///
  /// Runs [computation] in a new isolate and returns the result. When
  /// cancelled, the isolate is killed.
  ///
  /// When building for the web platform, this uses [CancellableFuture.from] as
  /// a fallback due to isolates being unsupported.
